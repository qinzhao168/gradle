...
class DefaultProjectTest {
    ...
    WorkerDaemonService workerDaemonService = context.mock(WorkerDaemonService.class)
    ...
    void setUp() {
        ...
        context.checking {
            ...
            allowing(serviceRegistryMock).get((Type) WorkerDaemonService); will(returnValue(workerDaemonService))
